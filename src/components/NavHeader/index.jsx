   ...
   return (
      <Popover className="relative rounded-br-[35px] bg-bgBlue">
         <div className="px-4 mx-auto max-w-7xl sm:px-6">
            <div className="flex items-center justify-between py-6 marker:md:justify-start md:space-x-10">
               ...
               <Popover.Group as="nav" className="hidden space-x-5 md:flex">
                  <a href="/" className="text-base font-medium links">
                     Início
                  </a>
               ...
               <div className="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
                  <a
                     href="/login"
                     className="text-base font-medium text-bgColor whitespace-nowrap hover:text-cBlue-600"
                  >
                     Login
                  </a>
                  <a
         ...
         >
            ...
            >
               <div className="divide-y-2 rounded-lg shadow-lg bg-cBlue-102 ring-1 ring-black ring-opacity-5 divide-cBlue-300">
                     ...
                     <div className="mt-6">
                        <nav className="grid gap-y-8">
                           {linksMobile.map((item) => (
                              ...
                              >
                                 <item.icon
                                    className="flex-shrink-0 w-6 h-6 text-linkBlue"
                                    aria-hidden="true"
                                 />
                  ...
                  <div className="px-5 py-6 space-y-6">
                     <div>
                        ...
                        <p className="mt-6 text-base font-medium text-center text-bgColor">
                           ...
                           <a
                              href="/login"
                              className="underline underline-offset-1 text-cBlue-400 hover:text-cBlue-600"
                           >
                              Faça login
                           </a>
                        </p>
